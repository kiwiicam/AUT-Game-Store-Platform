...
router.post('/updatestudentinfo', updateStudentInfo);
router.post('/getstudentinfo', getStudentInfo);
router.post('/getdeveloperinfogame', getDevInfoGamePage);
